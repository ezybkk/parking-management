...
<body>
	<header>
		<div class="main">
			...
			<ul>
				<li class="active"><a href="index.php">Sign Out</a></li>
			</ul>
			</div>
		</header>
		<div class="content">	
		...
		<div class="table-slot">
			<table>
				<caption>Welcome Operator!</caption>
				<tr>
					<th>Slot</th>
					<th>Status</th>
					<th></th>
				...
				<tr>
					...
					while($res = mysqli_fetch_array($result)){
                        ...
                        if($res['availability']=='Available'){
							...
							echo "<td><a href='bill.php?slot=".$res['slot_number']."' class='btn2'>BOOK</a></td>";
						}
						// echo "<td><a href=book.php?slot=".$res['slot_number']." class='btn2'>BOOK</a></td>";
						// echo "<td><a href='javascript:void()' class='btn2'>Test</a></td>"; BACKUP
						//	echo "<td><a href=book.php?slot=".$res['slot_number']." class='btn2'>BOOK</a></td>";
					}
					 ?>
				</tr>
